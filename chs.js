...
var cnItems = {
    ...
    "\"Is that... housing I could use?\", he says, with a timid voice. You nod, and ask him if he'd like to become your first apprentice. He shakes, visibly and clearly nervous.": "“那是……我可以使用的住房吗？”他用胆怯的声音说道。 你点点头，问他愿不愿意做你的第一个徒弟。 他颤抖着，显然很紧张。",
    ...
    "Construction for the first apprentice dorm is finished! You celebrate to a small audience. You notice the apprentice from before is still there. You approach him, though he still seems fearful and bows deeply.": "第一个学徒宿舍建设完成！ 你向一小群观众庆祝。 你注意到之前的徒弟还在。 你走近他，尽管他看起来仍然很害怕并且深深地鞠躬。",
    "Crafting Station": "制作站",
    "Create Iron Bar": "制造铁锭",
    "Create Water III": "造水三",
    "Do you want to retire?": "你想退休吗？",
    "Everything will revert back to its initial state, except:": "一切都会恢复到初始状态，除了：",
    "If you retire now, your research multiplier will become 1.51x (+51.1%) and your production and loot multiplier will become 1.06x (+5.61%).": "如果您现在退休，您的研究乘数将变为 1.51 倍 (+51.1%)，您的生产和战利品乘数将变为 1.06 倍 (+5.61%)。",
    "If you retire,": "如果你退休",
    "Load": "加载",
    "Loadouts:": "装载：",
...
var cnRegReplace = new Map([
    ...
    [/^One of your researchers seems to have come across a dusty book. The book seems to contain knowledge about Conjuration. Thrilled, your researchers get back to work with the new knowledge.\n  \n  \*\*You gain (.+) Conjuration experience!\*\*$/, '您的一位研究人员似乎遇到了一本布满灰尘的书。 这本书似乎包含有关召唤的知识。 兴奋不已，你的研究人员开始使用新知识开展工作。\n \n **你获得 $1 点召唤经验！**'],
