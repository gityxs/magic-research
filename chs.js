...
var cnItems = {
    ...
    "Craft a Headmaster's Staff (1500 Mana, 3500 Wood, Requires Conjuration Lv8)": "制作校长的法杖（1500 法力，3500 木头，需要召唤 Lv8）",
    ...
    "You can unlock new items to craft by increasing your school levels. Conjuration and Enchantment typically unlock new items to craft, but other schools may also unlock new items. In some cases, some items may require a certain level from multiple schools at once. For example, the item \"Branch\" requires Lv4 Conjuration and Lv4 Enchantment.": "你可以通过提高你的学校等级来解锁新的物品来制作。 魔法和附魔通常会解锁新物品以进行制作，但其他学校也可能会解锁新物品。 在某些情况下，某些项目可能需要同时从多个学校获得一定的等级。 例如，项目“分支”需要 Lv4 召唤 和 Lv4 附魔。",
    ...
    "(Storyline) Evocation": "（剧情）Evocation",
    ...
    "You have completed the \"Evocation\" storyline and have permanently unlocked the Evocation school! You may now do research on Evocation, which will let you learn damaging combat spells. This will persist even after restarting the game!": "您已经完成了“Evocation”故事情节并永久解锁了 Evocation学校！ 你现在可以研究 Evocation，这会让你学习破坏性的战斗法术。 即使重新启动游戏，这种情况也会持续存在！",
...
var cnRegReplace = new Map([
    ...
    [/^(.+)Congratulations!\n      \nYour Conjuration level is now (.+)!\n\n\n\n\*\*New craftable items:\*\*\n:assassinsDagger:\*Assassin\'s Dagger\* \(Conjuration Lv(.+)\)$/, '$1恭喜！\on \你的召唤等级现在是 $2！\n\n\n\n**新的可制作物品：**\n:刺客匕首:*刺客匕首*（召唤 等级$3）'],
    [/^(.+)Congratulations!\n      \nYour Conjuration level is now (.+)!\n\n\n\n\*\*New craftable items:\*\*\n:sickle:\*Sickle\* \(Conjuration Lv(.+)\)$/, '$1恭喜！\on \你的召唤等级现在是 $2！\n\n\n\n**新的可制作物品：**\n:镰刀:*镰刀*（召唤 等级$3）'],
    [/^(.+)Congratulations!\n      \nYour Conjuration level is now (.+)!\n\n\n\n\*\*New craftable items:\*\*\n:spikedClub:\*Spiked Club\* \(Conjuration Lv(.+)\)$/, '$1恭喜！\on \你的召唤等级现在是 $2！\n\n\n\n**新的可制作物品：**\n:尖刺棒:*尖刺棒*（召唤 等级$3）'],
    [/^(.+)Congratulations!\n      \nYour Conjuration level is now (.+)!\n\n\n$/, '$1恭喜！\on \你的召唤等级现在是 $2！\n\n\n'],
    ...
    [/^Conjuration Lv(.+) \(Primary\)$/, '召唤 等级$1（主要）'],
