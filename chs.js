...
var cnItems = {
    ...
    "screen, you can access a few configuration options for the game and you can export or import your save data. You can use this feature to transfer your progress from the demo of Magic Research to the full game.": "屏幕上，您可以访问游戏的一些配置选项，并且可以导出或导入您的保存数据。 您可以使用此功能将您的进度从 Magic Research 演示转移到完整游戏。",
    ...
    "Wizard's Robe!": "巫师长袍！",
    "You hand over the coins and buy the robe. The businessman grins slightly. \"Great doooooing business with you!\", he exclaims, before handing the robe to you.": "你交出硬币并购买长袍。 商人微微一笑。 “跟你做生意太好了！”他说，然后把长袍递给你。",
